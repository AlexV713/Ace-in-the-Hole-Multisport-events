        ...
        <div id="wrapper">
            ...
            <table>
                <tbody>
                    <tr>
                        ...
                        <td class="event">Splash n' Dash</td>
                    </tr>
                    <tr>
                        <th>Time</th>
                        <td>8:00 AM</td>
            ...
            <div class="hide">
                <p><strong><span class="titles">Long Course SWIM - 1.2mi:</span></strong><br> Participants will make two
                    ...
                    will be present on the beach.
                    <br><br>
                    <strong><span class="titles">Long Course BIKE - 58 Miles:</span></strong> A scenic point-to-point
                    course that travels over
                    gently rolling hills
                    prior to three hard climbs. The bike course will be marked with large directional signage and there
                    will be course marshals at key intersections to help direct you.
                    <br><br>
                    <strong><span class="titles">Long Course RUN - 13.1mi:</span></strong> A mostly flat loop course on
                    widely paved bike paths that
                    traverse
                    through and around this beautiful and scenic destination resort (two hills total with a minimal
                    elevation gain).
                    <br><br>
                    <strong><span class="titles">OLYMPIC SWIM - 1,500 meters:</span></strong> Participants will make two
                    counter-clockwise loops.
                    Large buoys will
                    mark the turn points. Kayakers will be positioned on the water to support the swimmers. Medical
                    support will be present on the beach.
                    <br><br>
                    <strong><span class="titles">OLYMPIC BIKE - 28mi:</span></strong> A scenic point-to-point course
                    that travels over gently
                    rolling hills. The
                    bike course will be marked with large directional signage and course marshals will be present at key
                    intersections.
                    <br><br>
                    <strong><span class="titles">OLYMPIC RUN - 10K:</span></strong> A mostly flat loop course on widely
                    paved bike paths that
                    traverse through and
                    around this beautiful and scenic destination resort (one hill total with a minimal elevation gain).
                    <br><br>
                    <strong><span class="titles">Sprint:</span></strong> Course will offer a 1-loop 1/2 mile swim, the
                    exact same 28 mile Bike
                    Course as the Olympic
                    distance and a 5km run.
                    <br><br>
                    <strong><span class="titles">Try-A-Tri:</span></strong> This novice race is designed for the first
                    time triathlete, those new to
                    ...
                    <br><br>
                    <strong><span class="titles">Half Marathon COURSE:</span></strong> Half-Marathon (13.1-miles):
                    Half-Marathon event starts and
                    ...
                    <br><br>
                    <strong><span class="titles">10k COURSE:</span></strong> The 10K event starts and finishes in the
                    Athletes Village. The paths
                    ...
                    <br><br>
                    <strong><span class="titles">Splash n' Dash:</span></strong> Kids event for participants ages 4 to
                    15. This is a 100 yard swim
                    and a 50 yard dash. It is free if an adult registers for an event otherwise it is $25.
                </p>
            </div>
            ...
            <div class="hide">
                <p>Watch the weather closely. The show goes on no matter what the weather is doing.
                    <br><br>You must wear your chip timing piece during the entire event. You will be given a band that
                    will
                    hold your chip timing
                    piece around your ankle throughout the entire event. Be sure that it is snapped tightly. Be sure to
                    have
                    your Chip Timing piece on before you start the race and be sure to step over the timing mats after
                    each
                    segment of the race. If you are wearing a wet-suit, make sure the timing piece goes under your
                    wetsuit
                    otherwise, you will have a very difficult time getting off your wet suit.
                    <br><br><strong><span class="titles">Swim:</span></strong><br> Wetsuits are optional for the swim
                    but
                    will provide buoyancy and warmth. However, many people opt for no
                    wetsuit for a triathlon so no worries. We will provide you with a swim cap but you will want to
                    bring
                    your own goggles. <br><br>
                    <strong><span class="titles">Bike:</span></strong><br> A biking helmet is mandatory. You will also
                    receive 2
                    stickers in your package with your race number on them. The small sticker should go on the front of
                    your
                    helmet. The bigger sticker will wrap around your bike frame. Road or mountain bikes are acceptable.
                    For
                    safety reasons, be sure to have end-caps on the end of your handle-bars.
                    <br><br><strong><span class="titles">Run:</span></strong><br> You must finish the race with your bib
                    number on the front of you. Some people choose to pin it on at
                    ...
                    bike.
                    Others use an elastic racing strap that they pin their bib number to and then quickly strap it on
                    before
            ...
            <div class="hide">
                ...
                <p><strong>COURSE DETAILS
                        WATER TEMPERATURE is expected to be between 62 & 66 degrees. The temperature will be taken on
                        Friday
